...
//                                    Toast.makeText(this,"Congratulation you made to the end",Toast.LENGTH_LONG).show()
                        ...
                        question?.let {
                            ...
                            if(it.correctAnswer != mSelectedOptionPosition) {
                                ...
                                resultView(mSelectedOptionPosition,R.drawable.ic_clear)

                            } else {
                                mCorrectAnswer++
                            }
                            answerView(it.correctAnswer,R.drawable.correct_option_border_bg)
                            resultView(it.correctAnswer,R.drawable.ic_check)
    ...
    private fun resultView(answer: Int, drawableView: Int) {
        when (answer) {
            1 -> {
              //  tvOptionOne?.background = ContextCompat.getDrawable(this,drawableView)
                tvOptionOne?.setCompoundDrawablesWithIntrinsicBounds(0, 0,  drawableView,0);
            }
            2 -> {
              //  tvOptionTwo?.background = ContextCompat.getDrawable(this,drawableView)
                tvOptionTwo?.setCompoundDrawablesWithIntrinsicBounds(0, 0, drawableView,0);
            }
            3 -> {
              //  tvOptionThree?.background = ContextCompat.getDrawable(this,drawableView)
                tvOptionThree?.setCompoundDrawablesWithIntrinsicBounds(0, 0,  drawableView,0);
            }
            4 -> {
               // tvOptionFour?.background = ContextCompat.getDrawable(this,drawableView)
                tvOptionFour?.setCompoundDrawablesWithIntrinsicBounds(0, 0,  drawableView,0);
            }
        }
    }
